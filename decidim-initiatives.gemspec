...
Gem::Specification.new do |s|
  ...
  s.add_dependency "decidim-admin", ">= 0.8.4", "0.9.0.pre"
  s.add_dependency "decidim-comments", ">= 0.8.4", "0.9.0.pre"
  s.add_dependency "decidim-core", ">= 0.8.4", "0.9.0.pre"
  s.add_dependency "decidim-verifications", ">= 0.8.4", "0.9.0.pre"
  ...
  s.add_development_dependency "decidim-dev", ">= 0.8.4", "0.9.0.pre"
end
