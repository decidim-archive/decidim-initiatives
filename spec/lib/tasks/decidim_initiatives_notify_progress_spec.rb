...
describe 'rake decidim_initiatives:notify_progress', type: :task do
  ...
  context 'Initiative without supports' do
  ...
  context 'Initiative ready for first notification' do
    let(:initiative) do
  ...
  context 'Initiative ready for second notification' do
    let(:initiative) do
      initiative = create(:initiative, first_progress_notification_at: DateTime.now)
  ...
  context 'Initiative with both notifications sent' do
    let(:initiative) do
      create(:initiative,
             first_progress_notification_at: DateTime.now,
             second_progress_notification_at: DateTime.now
      )
    end
